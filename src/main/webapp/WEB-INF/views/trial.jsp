	...
	<c:if test="${!empty categoryList}">
		<div>
			<ul class="w3-navbar w3-light-grey w3-round w3-small menu w3-card-4 "
				...
				<li style="float: right"><a href="${id}/viewcart"
					class="w3-hover-none"><i class="fa fa-shopping-cart"></i> View
						Cart</a></li>
		...
		<div>
			<ul>
				<c:forEach items="${productList}" var="product">
					...
					<li><a href="${id}/addtoCart/${product.id}"
		...
		<div>
			<ul>
				<c:forEach items="${productList}" var="product">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="${id}/addtoCart/${product.id}">CLOTHING <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#">Ethnic wear</a></li>
							<li><a href="#">Western wear</a></li>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">ACCESSORIES <span
							class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#">Jewellery</a></li>
							<li><a href="#">HandBags</a></li>
			...
			<div class="col-sm-9 col-md-10 main">
				...
				LET BEING IN FASHION BE A PASSION.. 
				</h2>
          ...
          <hr>
			...
			<div class="container" style="padding-top: 20px;">
				<ul class="nav nav-tabs">
					...
					<li class="active col-md-6"><a data-toggle="tab" href="#menu1">GET
							VERVED WITH FABIC..!</a></li>
					<li class="col-md-6"><a data-toggle="tab" href="#menu2">ADD
							ON THE LOOK..</a></li>
				...
				<div class="tab-content">
					...
					<div class="container" style="padding-top: 20px;">
						<ul class="nav nav-tabs">
							...
							<li class="active col-md-6"><a data-toggle="tab"
								href="#menu1">GET VERVED WITH FABIC..!</a></li>
							<li class="col-md-6"><a data-toggle="tab" href="#menu2">ADD
									ON THE LOOK..</a></li>
						...
						<div class="tab-content">
							<div id="menu1" class="tab-pane fade in active">
								<div class="row" style="margin-top: 10px;">
									...
									<div class="col-sm-6 col-md-3">
										<div class="thumbnail hovereffect">
											<img class="img-responsive"
												src="F:\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp2\wtpwebapps\application\resources\images\product\P001.jpg"
												alt="...">
											<div class="caption">
												<h3></h3>
												<p>...</p>
												<p>
													<a href="${id}/addtoCart/${product.id}" class="btn btn-primary" role="button">ADD
														TO CART</a>
												</p>
											</div>
										</div>
									...
									<div class="col-sm-6 col-md-3">
										<div class="thumbnail hovereffect">
											...
											<div class="caption">
												...
												<p>...</p>
												<p>
													<a href="#" class="btn btn-primary" role="button">Add
														To Cart</a>
												</p>
											</div>
										</div>
							...
							<!-- row test end -->
							<footer> <section id="conatcat-info">
							<div class="container">
								<div class="row">
									<div class="col-sm-8">
										<div class="media contact-info wow fadeInDown"
											...
											<div class="media-body">
												...
												<p>We are grateful for your concern, love to hear from
													you and just phone call away to serve you. Do reach us at:
													+0123 456 70 80</p>
											</div>
										</div>
									</div>
